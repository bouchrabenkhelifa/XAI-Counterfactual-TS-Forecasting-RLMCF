...
from src.training.RL_nv_trainer import RLNVTrainer
...
CONFIG_RL = "assets/configs/models/etth1_dataset/RL/rl_nv.json"

# Checkpoint RL-NV déjà entraîné
CHECKPOINT_PATH = "assets/checkpoints/RL_nv/rl_nv_agent_best.pt"

# Modèle externe de plausibilité (garde-le seulement pour l'évaluation)
...
def save_examples_plot(examples, out_path, rho=0.10):
    ...
    plt.suptitle("Frozen checkpoint evaluation — RL NV", fontsize=13)
    plt.tight_layout()
...
def main():
    ...
    # Construit le pipeline NV puis charge le checkpoint déjà entraîné
