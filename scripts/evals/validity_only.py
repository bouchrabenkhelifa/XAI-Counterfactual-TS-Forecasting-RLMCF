...
CONFIG_RL = "assets/configs/models/etth1_dataset/RL_ablations/validity_only.json"

CHECKPOINT_PATH = "assets/checkpoints/etth1_chpts/RL_ablations/validity_only/validity_only_agent_best.pt"
