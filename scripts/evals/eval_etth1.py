"""
Eval ETTh1 — Combine Colab results with local plausibility
===========================================================
...
Usage:
    python scripts/evals/eval_etth1_from_colab.py
"""
...
MODELS = [
    (
        "iTransformer",
        "assets/results/etth1/RL/ablations/rl_cf_v2_etth1_evaluation.json",
    ...
    (
        "PatchTST",
        "assets/results/etth1/RL/patchtst/rl_cf_patchtst_etth1_evaluation.json",
    ...
    (
        "TimesNet",
        "assets/results/etth1/RL/timesnet/rl_cf_timesnet_etth1_evaluation.json",
    ...
    (
        "GRU",
        "assets/results/etth1/RL/gru/rl_cf_gru_etth1_evaluation.json",
    ...
    (
        "DLinear",
        "assets/results/etth1/RL/dlinear/rl_cf_dlinear_etth1_evaluation.json",
...
def print_table(results: dict):
    ...
    print(f"\n{'='*60}")
    print(f"  ETTh1 — Colab metrics + Local plausibility")
    print(f"{'='*60}")
    print(header)
    print(sep)
...
def plot_radar(results: dict, out_dir: str):
    ...
    ax.set_ylim(0, 1)
    ax.set_title("ETTh1 — RL-MCF (Colab + Local Plaus.)", fontsize=13, fontweight="bold", pad=20)
    ax.legend(loc="upper right", bbox_to_anchor=(1.3, 1.1), fontsize=10)
    ax.grid(True, alpha=0.3, linestyle='--')
    fig.tight_layout()
    p = os.path.join(out_dir, "etth1_radar_5models_colab.png")
...
def plot_barplot(results: dict, out_dir: str):
    ...
    ax.set_ylabel("Score")
    ax.set_title("ETTh1 — RL-MCF: Colab metrics + Local Plausibility", fontsize=13)
    ax.legend(fontsize=9)
    ax.grid(axis="y", alpha=0.3)
    fig.tight_layout()
    p = os.path.join(out_dir, "etth1_barplot_5models_colab.png")
...
def main():
    ...
    # Sauvegarder JSON
    out_json = os.path.join(OUTPUT_DIR, "etth1_all_models_colab_plaus.json")
