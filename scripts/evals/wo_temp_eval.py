...
CONFIG_RL = "assets/configs/models/etth1_dataset/RL_ablations/wo_temporal.json"

CHECKPOINT_PATH = "assets/checkpoints/etth1_chpts/RL_ablations/wo_temporal/wo_temporal_agent_best.pt"
