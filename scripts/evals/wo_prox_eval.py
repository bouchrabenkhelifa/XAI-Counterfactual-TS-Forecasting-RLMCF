...
CONFIG_RL = "assets/configs/models/etth1_dataset/RL_ablations/wo_proximity.json"

CHECKPOINT_PATH = "assets/checkpoints/etth1_chpts/RL_ablations/wo_proximity/without proximity_agent_best.pt"
