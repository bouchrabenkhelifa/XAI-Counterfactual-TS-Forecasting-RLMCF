...
def trainer_run_episode(trainer, batch, filter_quantile=0.75):
    """
    Reproduit l'épisode du trainer mais sans entraînement.
    """
    ...
    a, log_prob, _ = trainer.agent.actor.sample(s)
...
def main():
    ...
    summary, examples = evaluate_frozen_model(
        ...
        evaluator=evaluator,
        n_batches=20,
        include_dtw=False,   # mets True si dtaidistance est installé
    )
