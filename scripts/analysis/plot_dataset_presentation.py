...
Output:
    assets/figures/analysis/dataset_presentation_etth1.png
    assets/figures/analysis/dataset_presentation_etth2.png
    assets/figures/analysis/dataset_presentation_weather.png
"""
