...
class RLStrictTrainer:
    ...
    def _save_checkpoint(self, tag):
        torch.save({
            ...
            f"rl_strict2_agent_{tag}.pt"
        ))

    def _save_history(self):
        path = os.path.join(
            self.cfg_rl.results_dir_lp,
            "rl_strict2_history.json"
        )
    ...
    def _plot_training(self):
        ...
        path = os.path.join(
            ...
            "rl_strict2_training_curves.png"
        )
...
if __name__ == "__main__":
    ...
    print("\n✅ Done !")
    print(f"  Checkpoint → {cfg_rl.checkpoint_dir_lp}/rl_strict2_agent_best.pt")
    print(f"  Figures    → {cfg_rl.figures_dir_lp}/")
    print(f"  Results    → {cfg_rl.results_dir_lp}/rl_strict2_history.json")