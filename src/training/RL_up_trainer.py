...
class RLTrainerUpdated:
    def __init__(self, cfg_forecaster, cfg_ae, cfg_rl, device):
        ...
        print(f"[RL-Updated] Objectif : réduire mean(forecast) de {cfg_rl.rho * 100:.0f}%")
        ...
        print(f"[RL-Updated] Actor {params['actor']:,}  Critic {params['critic']:,}")
    ...
    def _save_checkpoint(self, tag):
        ...
        }, os.path.join(self.cfg_rl.checkpoint_dir_lp, f"rl_updated_agent_{tag}.pt"))

    def _save_history(self):
        path = os.path.join(self.cfg_rl.results_dir_lp, "rl_updated_history.json")
    ...
    def _plot_training(self):
        ...
        plt.tight_layout()
        path = os.path.join(self.cfg_rl.figures_dir_lp, "rl_updated_training_curves.png")
    ...
    def _plot_cf_examples(self, examples):
        ...
        plt.tight_layout()
        path = os.path.join(self.cfg_rl.figures_dir_lp, "rl_updated_cf_examples.png")
        plt.savefig(path, dpi=150, bbox_inches="tight")
        plt.close()
...
if __name__ == "__main__":
    ...
    print("Pipeline : RL Updated (latent + updated plausibility)")
