...
from src.models.pipeline.reward import CFReward
...
class RLTrainer:
    ...
    def train(self):
        print(f"\n{'=' * 60}")
        print(
            f"RL Training | {self.cfg_rl.epochs} epochs | "
    ...
    def evaluate(self, n_batches=20):
        ...
        stats = {
            k: [] for k in ["total", "validity", "proximity", "delta_mean", "success"]
        }
        cf_examples = []
        ...
        print(
            f"  Success = {np.mean(stats['success']) * 100:.1f}% "
